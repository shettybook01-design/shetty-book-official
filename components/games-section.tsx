...
export function GamesSection() {
  const openWhatsApp = (gameName: string, WHATSAPP_NUMBER: string) => {
  ...
  return (
    <section id="games-section" className="mx-auto max-w-7xl px-4 py-16 md:px-6">
      ...
      <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {GAMES.map((game) => (
          <button
            ...
            className="group relative w-full overflow-hidden rounded-xl border border-border/60 bg-card text-left shadow-lg"
          >
